...
def url_encode_sparql_query(web_url: str, sparql_query: str):
    """
    ...
    encoded_url = f"{web_url}{encoded_query}"
    
    return encoded_url
 

@task(name="fetch entries with SPARQL query", retries=3, retry_delay_seconds=120)
def fetch_sparql_to_csv(web_url: str, sparql_query: str) -> str:
    """
    ...
    try:
        encoded_url = url_encode_sparql_query(web_url, sparql_query)
